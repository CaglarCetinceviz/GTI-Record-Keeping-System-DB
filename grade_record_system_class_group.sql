...
CREATE TABLE `class_group` (
  ...
  KEY `fk_class_group_course1_idx` (`course_id`),
  CONSTRAINT `fk_class_group_course1` FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`)
...
INSERT INTO `class_group` VALUES ('PSD1','5M0529'),('PSD2','5M0529'),('ASD','6M0691');
